<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Edit Locality') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Update locality information') }}</flux:subheading>
    ...
    <div class="max-w-2xl">
        <form wire:submit="update">
            ...
            <div class="flex justify-end gap-3 mt-6">
                ...
                <button type="submit" wire:loading.attr="disabled" wire:target="update" :disabled="$isSubmitting"
