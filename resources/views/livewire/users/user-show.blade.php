<div>
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 border dark:border-gray-700">
            <tbody>
                <tr class="border-b dark:border-gray-700 bg-white dark:bg-gray-900">
                    <th class="px-6 py-3 font-medium text-gray-900 dark:text-white">Nombre:</th>
                    <td class="px-6 py-3 border-r dark:border-gray-700 text-gray-600 dark:text-gray-300">{{ $user->name }}</td>
                    <th class="px-6 py-3 font-medium text-gray-900 dark:text-white">DNI:</th>
                    <td class="px-6 py-3 border-r dark:border-gray-700 text-gray-600 dark:text-gray-300">{{ $user->dni ?? 'No especificado' }}</td>
                    <th class="px-6 py-3 font-medium text-gray-900 dark:text-white">Correo:</th>
                    <td class="px-6 py-3 text-gray-600 dark:text-gray-300">{{ $user->email ?? 'No especificado' }}</td>
                </tr>
                <tr class="border-b dark:border-gray-700 bg-white dark:bg-gray-900">
                    <th class="px-6 py-3 font-medium text-gray-900 dark:text-white">Teléfono:</th>
                    <td class="px-6 py-3 border-r dark:border-gray-700 text-gray-600 dark:text-gray-300">{{ $user->phone ?? 'No especificado' }}</td>
                    <th class="px-6 py-3 font-medium text-gray-900 dark:text-white">Departamento:</th>
                    <td class="px-6 py-3 border-r dark:border-gray-700 text-gray-600 dark:text-gray-300">{{ $user->department->name ?? 'No especificado' }}</td>
                    <th class="px-6 py-3 font-medium text-gray-900 dark:text-white">Municipio:</th>
                    <td class="px-6 py-3 text-gray-600 dark:text-gray-300">{{ $user->municipality->name ?? 'No especificado' }}</td>
                </tr>
                <tr class="border-b dark:border-gray-700 bg-white dark:bg-gray-900">
                    <th class="px-6 py-3 font-medium text-gray-900 dark:text-white">Localidad:</th>
                    <td class="px-6 py-3 border-r dark:border-gray-700 text-gray-600 dark:text-gray-300">{{ $user->locality->name ?? 'No especificado' }}</td>
                    <th class="px-6 py-3 font-medium text-gray-900 dark:text-white">Dirección:</th>
                    <td class="px-6 py-3 border-r dark:border-gray-700 text-gray-600 dark:text-gray-300">{{ $user->address ?? 'No especificado' }}</td>
                    <th class="px-6 py-3 font-medium text-gray-900 dark:text-white">Género:</th>
                    <td class="px-6 py-3 text-gray-600 dark:text-gray-300">{{ $user->gender ?? 'No especificado' }}</td>
                </tr>
                <tr class="border-b dark:border-gray-700 bg-white dark:bg-gray-900">
                    ...
                    <td class="px-6 py-3 text-gray-600 dark:text-gray-300" colspan="3">
                        ...
                        @else
                            @foreach ($user->roles as $role)
                                <span class="inline-flex items-center px-2 py-1 mr-1 text-xs font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300">{{ $role->name }}</span>
                            @endforeach
                        @endif
                    </td>
                </tr>
    ...
    {{-- Grid de patologías y medicamentos --}}
