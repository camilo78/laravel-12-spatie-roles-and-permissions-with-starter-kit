                            ...
                            <tbody>
                                @foreach ($user->patientPathologies as $key => $pathology)
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            <span
                                                class="inline-flex items-center px-2 py-1 text-xs font-medium rounded-full {{ $pathology->status === 'active' ? 'text-green-800 bg-green-200 dark:bg-green-700 dark:text-green-300' : 'text-gray-800 bg-gray-200 dark:bg-gray-700 dark:text-gray-300' }}">
                            ...
                            <tbody>
                                @foreach ($userMedicines as $key => $medicine)
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            <span
                                                class="inline-flex items-center px-2 py-1 text-xs font-medium rounded-full {{ $medicine->status === 'active' ? 'text-green-800 bg-green-200 dark:bg-green-700 dark:text-green-300' : 'text-gray-800 bg-gray-200 dark:bg-gray-700 dark:text-gray-300' }}">
